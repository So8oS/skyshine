...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Plane_Grey_0_1: THREE.Mesh;
    Plane_Grey_0_2: THREE.Mesh;
          ...
          >
            <group name="RootNode">
              ...
              <group
                ...
                scale={100}
              >
                <group name="Plane_Grey_0" position={[0, 0.44, -0.132]}>
                  <mesh
                    name="Plane_Grey_0_1"
                    castShadow
                    receiveShadow
                    geometry={nodes.Plane_Grey_0_1.geometry}
                    material={materials.Grey}
                  />
                  <mesh
                    name="Plane_Grey_0_2"
                    castShadow
                    receiveShadow
                    geometry={nodes.Plane_Grey_0_2.geometry}
                    material={materials["Material.001"]}
                  />
                  <group
                    ref={nozzleRef}
                    name="nozzleHaed"
                    position={[0.009, -1.595, 0.001]}
                    rotation={[-Math.PI / 2, 0, Math.PI]}
                    scale={0.919}
                  />
                </group>
